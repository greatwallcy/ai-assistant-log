...
/* ======================== 铜排温度检测 (ADS1115IDGSR, 4路NTC) ======================== */
#define CB_TEMP_SDA_PORT     GPIOB
#define CB_TEMP_SDA_PIN      GPIO_PIN_7  /* PB7 */
#define CB_TEMP_SCL_PORT     GPIOB
#define CB_TEMP_SCL_PIN      GPIO_PIN_6  /* PB6 */
#define CB_TEMP_ADS1115_ADDR 0x48        /* ADS1115IDGSR 7-bit地址 (ADDR=GND) */
