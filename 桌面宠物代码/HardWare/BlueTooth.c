...
void USART1_IRQHandler(void)
{
	if(USART_GetITStatus(USART1,USART_IT_RXNE)==SET)//如果接受到
	{
		...
		else if(USART_ReceiveData(USART1)==0x50)//跳舞
		{
			Face_Mode=6;
			Face_Config();
			Action_Mode=16;
		}
		else if(USART_ReceiveData(USART1)==0x51)//左右摇摆
		{
			Face_Mode=6;
			Face_Config();
			Action_Mode=17;
		}
		else if(USART_ReceiveData(USART1)==0x52)//俯卧撑
		{
			Face_Mode=6;
			Face_Config();
			Action_Mode=18;
		}
		else if(USART_ReceiveData(USART1)==0x53)//伸手
		{
			Face_Mode=6;
			Face_Config();
			Action_Mode=19;
		}
		else if(USART_ReceiveData(USART1)==0x54)//放下
		{
			Face_Mode=6;
			Face_Config();
			Action_Mode=20;
		}
		else if(USART_ReceiveData(USART1)==0x60)//随机播放
		{
			Face_Mode=6;
			Face_Config();
			Action_Mode=21;
		}
		else if(USART_ReceiveData(USART1)==0x61)//单曲循环结束
		{
			Face_Mode=6;
			Face_Config();
			Action_Mode=22;
		}
		else if(USART_ReceiveData(USART1)==0x62)//单曲循环开始
		{
			Face_Mode=6;
			Face_Config();
			Action_Mode=23;
		}
		else if(USART_ReceiveData(USART1)==0x63)//循环播放开始
		{
			Face_Mode=6;
			Face_Config();
			Action_Mode=24;
		}
		else if(USART_ReceiveData(USART1)==0x64)//循环播放结束
		{
			Face_Mode=6;
			Face_Config();
			Action_Mode=25;
		}
		else if(USART_ReceiveData(USART1)==0x65)//下一曲
		{
			Face_Mode=6;
			Face_Config();
			Action_Mode=26;
		}
		else if(USART_ReceiveData(USART1)==0x66)//上一曲
		{
			Face_Mode=6;
			Face_Config();
			Action_Mode=27;
		}
		else if(USART_ReceiveData(USART1)==0x67)//音量加
		{
			Face_Mode=6;
			Face_Config();
			Action_Mode=28;
		}
		else if(USART_ReceiveData(USART1)==0x68)//音量减
		{
			Face_Mode=6;
			Face_Config();
			Action_Mode=29;
		}
		else if(USART_ReceiveData(USART1)==0x69)//停止播放
		{
			Face_Mode=6;
			Face_Config();
			Action_Mode=30;
		}
		else if(USART_ReceiveData(USART1)==0x70)//播放
		{
			Face_Mode=6;
			Face_Config();
			Action_Mode=31;
		}
		else if(USART_ReceiveData(USART1)==0x71)//暂停
		{
			Face_Mode=6;
			Face_Config();
			Action_Mode=32;
		}
		else if(USART_ReceiveData(USART1)==0x72)//循环所有目录开始
		{
			Face_Mode=6;
			Face_Config();
			Action_Mode=33;
		}
		else if(USART_ReceiveData(USART1)==0x73)//循环所有目录结束
		{
			Face_Mode=6;
			Face_Config();
			Action_Mode=34;
		}
		else if(USART_ReceiveData(USART1)==0x74)//普通音乐播放
		{
			Face_Mode=6;
			Face_Config();
			Action_Mode=35;
		}
		else if(USART_ReceiveData(USART1)==0x75)//戏曲播放
		{
			Face_Mode=6;
			Face_Config();
			Action_Mode=36;
		}
		else if(USART_ReceiveData(USART1)==0x76)//儿歌播放
		{
			Face_Mode=6;
			Face_Config();
			Action_Mode=37;
		}
		else if(USART_ReceiveData(USART1)==0x77)//音量设置为40
		{
			Face_Mode=6;
			Face_Config();
			Action_Mode=38;
		}
		else if(USART_ReceiveData(USART1)==0x78)//音量设置为20
		{
			Face_Mode=6;
			Face_Config();
			Action_Mode=39;
